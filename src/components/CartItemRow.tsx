...
export const CartItemRow = React.memo<CartItemRowProps>(({
  ...
  return (
    <div
      ...
      onClick={onSelect}
      className={`flex items-center justify-between px-3 py-2 border rounded-xl transition-all duration-200 cursor-pointer ${
        isSelected
    ...
    >
      <div className="flex items-center gap-2.5 min-w-0 flex-1">
        ...
        <div className="min-w-0 flex-1">
          <h4
            className="font-bold text-slate-800 text-sm leading-tight line-clamp-1 uppercase"
            title={displayName}
          >
            {displayName}
          </h4>
          <div className="flex items-center gap-1 flex-wrap mt-0.5">
            ...
            {appliedPriceType === 'price_override' && (
              <span className="text-[10px] font-extrabold text-purple-700 bg-purple-50 border border-purple-200 px-1.5 py-0.2 rounded-md flex items-center gap-1 shadow-2xs">
            ...
            {appliedPriceType === 'price_list' && (
              <span className="text-[10px] font-extrabold text-indigo-700 bg-indigo-50 border border-indigo-200 px-1.5 py-0.2 rounded-md">
      ...
      <div className="flex items-center gap-2.5 flex-shrink-0">
        ...
        <div className="flex items-center bg-white border border-slate-200 rounded-lg p-0.5 shadow-2xs">
          <button
            ...
            className="p-1 text-slate-500 hover:text-indigo-600 hover:bg-slate-50 rounded-md transition-colors cursor-pointer"
          >
        ...
        <div className="text-right min-w-[60px] flex flex-col items-end">
          ...
          <button
            ...
            className="text-[11px] text-red-500 hover:text-red-700 hover:underline inline-flex items-center gap-0.5 cursor-pointer leading-none"
          >
